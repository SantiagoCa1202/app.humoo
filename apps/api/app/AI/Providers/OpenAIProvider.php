            ...
            'properties' => [
                ...
                'slots' => [
                    ...
                    'properties' => [
                        ...
                        'entity_type' => ['type' => ['string', 'null'], 'enum' => ['event', 'client', 'contact', 'venue', 'menu', 'menu_item', 'recipe', 'prep_list', 'prep_item', null]],
                        ...
                        'input' => [
                            ...
                            'properties' => [
                                ...
                                'prep_list_id' => ['type' => ['string', 'null']], 'prep_list_search' => ['type' => ['string', 'null']], 'prep_item_id' => ['type' => ['string', 'null']], 'prep_item_search' => ['type' => ['string', 'null']], 'assignee_search' => ['type' => ['string', 'null']], 'membership_id' => ['type' => ['string', 'null']], 'guest_count' => ['type' => ['integer', 'null']], 'menu_version_id' => ['type' => ['string', 'null']], 'include_assignments' => ['type' => ['boolean', 'null']], 'preserve_completed_items' => ['type' => ['boolean', 'null']], 'preserve_assignments' => ['type' => ['boolean', 'null']], 'assignment_membership_id' => ['type' => ['string', 'null']], 'quantity' => ['type' => ['number', 'null']], 'unit_id' => ['type' => ['string', 'null']], 'portions' => ['type' => ['number', 'null']], 'yield_quantity' => ['type' => ['number', 'null']], 'yield_unit_id' => ['type' => ['string', 'null']], 'actual_quantity' => ['type' => ['number', 'null']], 'actual_unit_id' => ['type' => ['string', 'null']], 'blocked_reason' => ['type' => ['string', 'null']],
                            ],
                        ],
                    ],
                ],
