...
class OpenAIProvider implements AIProvider, ToolCallingProvider
{
    ...
    private function instructions(array $context): string
    {
        ...
        return implode("\n", array_filter([
            ...
            'For any show or detail request naming a record, use the module detail action and put the natural-language target in its *_search field. The backend searches authorized matches, asks the user to choose when needed, and then resolves the selected stable ID. Do not use a list action as the final response for a named show request.',
