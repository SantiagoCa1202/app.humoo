...
class ToolRegistry
{
    ...
    private function chatInputSchema(array $tool): array
    {
        return match ($tool['key'] ?? null) {
            ...
            'prep.generate', 'prep.regenerate' => ['additional_properties' => false, 'fields' => ['event_id', 'event_search', 'prep_list_id', 'prep_list_search', 'guest_count', 'menu_version_id', 'due_at', 'include_assignments', 'preserve_completed_items', 'preserve_assignments', 'notes', 'change_summary', 'name']],
